...
export default function Register() {
  ...
  if (success) {
    const approvedLimit = calculateApprovedLimit(
      parseInt(formData.monthly_salary),
    );
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-white dark:bg-gray-800 rounded-lg">
                    ...
                    <p className="font-semibold">
                      {formatIndianCurrency(parseInt(formData.monthly_salary))}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Add a new customer to the system with automatic credit limit
              calculation
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter the customer's details below. The approved credit limit
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      {formatIndianCurrency(
                        calculateApprovedLimit(
                          parseInt(formData.monthly_salary) || 0,
                        ),
                      )}
                    </p>
                  )}
